...
def _surface_path(*parts):
    return str(resources.files(__package__).joinpath("surface", *parts))
...
def room_to_rgb(room, room_structure=None):
    ...
    box_filename = _surface_path("box.png")
    box = imageio.imread(box_filename)

    box_on_target_filename = _surface_path("box_on_target.png")
    box_on_target = imageio.imread(box_on_target_filename)

    box_target_filename = _surface_path("box_target.png")
    box_target = imageio.imread(box_target_filename)

    floor_filename = _surface_path("floor.png")
    floor = imageio.imread(floor_filename)

    player_filename = _surface_path("player.png")
    player = imageio.imread(player_filename)

    player_on_target_filename = _surface_path("player_on_target.png")
    player_on_target = imageio.imread(player_on_target_filename)

    wall_filename = _surface_path("wall.png")
...
def get_proper_box_surface(surfaces_id, box_mapping, i, j):
    ...
    filename = _surface_path("multibox", surface_name)
...
def color_player_two(room_rgb, position, room_structure):
    player_filename = _surface_path("multiplayer", "player1.png")
    player = imageio.imread(player_filename)

    player_on_target_filename = _surface_path("multiplayer", "player1_on_target.png")
    player_on_target = imageio.imread(player_on_target_filename)
