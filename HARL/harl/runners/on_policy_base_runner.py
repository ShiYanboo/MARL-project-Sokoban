...
from harl.utils.configs_tools import init_dir, save_config, prettify_json_file
...
class OnPolicyBaseRunner:
    ...
    def close(self):
        ...
        if self.algo_args["render"]["use_render"]:
            ...
            summary_path = str(self.log_dir + "/summary.json")
            self.writter.export_scalars_to_json(summary_path)
            prettify_json_file(summary_path)
            self.writter.close()
            self.logger.close()
