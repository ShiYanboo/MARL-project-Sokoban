...
```bash
cd /path/to/MARL-project-sokoban/HARL
conda activate harl-sokoban
...
```bash
cd /path/to/MARL-project-sokoban/HARL
python scripts/plot_sokoban_metrics.py --run-dir results/sokoban/TwoPlayer-Sokoban-v0/happo/server_happo/seed-xxxxx-YYYY-MM-DD-HH-MM-SS
```
...
```text
HARL/results/<env>/<scenario>/<algo>/<exp_name>/seed-xxxxx-YYYY-MM-DD-HH-MM-SS/
```
